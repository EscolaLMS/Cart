...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'EscolaLms\Auth\Repositories\Contracts\UserRepositoryContract' => \EscolaLms\Auth\Repositories\UserRepository::class,
            'EscolaLms\Auth\Services\Contracts\AuthServiceContract' => \EscolaLms\Auth\Services\AuthService::class,
            'EscolaLms\Auth\Services\Contracts\UserServiceContract' => \EscolaLms\Auth\Services\UserService::class,
            'EscolaLms\Cart\Services\Contracts\OrderProcessingServiceContract' => \EscolaLms\Cart\Services\OrderProcessingService::class,
            'EscolaLms\Cart\Services\Contracts\OrderServiceContract' => \EscolaLms\Cart\Services\OrderService::class,
            'EscolaLms\Cart\Services\Contracts\ShopServiceContract' => \EscolaLms\Cart\Services\ShopService::class,
            'EscolaLms\Categories\Repositories\Contracts\CategoriesRepositoryContract' => \EscolaLms\Categories\Repositories\CategoriesRepository::class,
            'EscolaLms\Categories\Services\Contracts\CategoryServiceContracts' => \EscolaLms\Categories\Services\CategoryService::class,
            'EscolaLms\Core\Repositories\Contracts\AttachmentRepositoryContract' => \EscolaLms\Core\Repositories\AttachmentRepository::class,
            'EscolaLms\Core\Repositories\Contracts\ConfigRepositoryContract' => \EscolaLms\Core\Repositories\ConfigRepository::class,
            'EscolaLms\Core\Services\Contracts\AttachmentServiceContract' => \EscolaLms\Core\Services\AttachmentService::class,
            'EscolaLms\Core\Services\Contracts\ConfigServiceContract' => \EscolaLms\Core\Services\ConfigService::class,
            'EscolaLms\Courses\Repositories\Contracts\CourseH5PProgressRepositoryContract' => \EscolaLms\Courses\Repositories\CourseH5PProgressRepository::class,
            'EscolaLms\Courses\Repositories\Contracts\CourseProgressRepositoryContract' => \EscolaLms\Courses\Repositories\CourseProgressRepository::class,
            'EscolaLms\Courses\Repositories\Contracts\CourseRepositoryContract' => \EscolaLms\Courses\Repositories\CourseRepository::class,
            'EscolaLms\Courses\Repositories\Contracts\TopicRepositoryContract' => \EscolaLms\Courses\Repositories\TopicRepository::class,
            'EscolaLms\Courses\Services\Contracts\CourseServiceContract' => \EscolaLms\Courses\Services\CourseService::class,
            'EscolaLms\Courses\Services\Contracts\ProgressServiceContract' => \EscolaLms\Courses\Services\ProgressService::class,
            'EscolaLms\Payments\Repositories\Contracts\PaymentsRepositoryContract' => \EscolaLms\Payments\Repositories\PaymentsRepository::class,
            'EscolaLms\Payments\Services\Contracts\PaymentsServiceContract' => \EscolaLms\Payments\Services\PaymentsService::class,
            'EscolaLms\Scorm\Services\Contracts\ScormServiceContract' => \EscolaLms\Scorm\Services\ScormService::class,
            'EscolaLms\Tags\Repository\Contracts\TagRepositoryContract' => \EscolaLms\Tags\Repository\TagRepository::class,
            'EscolaLms\Tags\Services\Contracts\TagServiceContract' => \EscolaLms\Tags\Services\TagService::class,
            ...
            'cart' => \Treestoneit\ShoppingCart\CartManager::class,
            ...
            'payment-gateway' => \EscolaLms\Payments\Gateway\GatewayManager::class,
            'payment-gateway.driver' => \EscolaLms\Payments\Gateway\Drivers\StripeDriver::class,
            'payments' => \EscolaLms\Payments\Services\PaymentsService::class,
            ...
            'scorm-manager' => \Peopleaps\Scorm\Manager\ScormManager::class,
